...
```toml
clap-mcp = { version = "0.1.0-rc.2", features = ["derive", "http"] }
```
...
| Protocol versions | Same conformance set as stdio (`2025-11-25`, `2026-07-28`) via rmcp 3.1 `supported_protocol_versions` |
...
harness against the HTTP fixture (`active` @ `2025-11-25`, then `all` @
`2026-07-28`). See [conformance-baseline.md](conformance-baseline.md).
