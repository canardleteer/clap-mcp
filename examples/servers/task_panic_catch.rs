//! Task-augmented MCP server with `catch_in_process_panics = true` for integration tests.
...
#[command(
    name = "task-panic-catch",
    about = "Task-augmented tools with in-process panic catching",
...
fn run(cmd: Cli) -> String {
    match cmd {
        ...
        Cli::PanicDemo => panic!("demo panic in task-augmented tool"),
    }
}
